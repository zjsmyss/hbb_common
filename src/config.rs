...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
            ...
            map.insert("password".to_string(), "Ycxj@2025".to_string());
            RwLock::new(map)
        };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.55.115"];
pub const RS_PUB_KEY: &str = "ATE+4wi4JHfCyBgkZZII3oOfTmeWg2EhvxZSq+nWtMs=";
